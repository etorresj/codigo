...
<div id="wrapper">
	...
	<div id="rightContent">
		...
		<h3>Departamentos</h3>
		<table class="data">
			<form method="post" action="index.php?section=departamento">
				<tr>
					<td colspan="5">
						<table width="100%">
							<tr>
								<td>
									<a href="?section=agregarDepartamento">
										<input type="button" class="button" value="Agregar Departamento">
									</a>
								</td>
								<td align="right">
			...
			<tr class="data">
				...
				<td class="data"><?php echo $localidad['nombreEspecialidad'] ?></td>
				<td class="data" width="75px">
				<center>
					<a href="?section=editarDepartamento&id=<?php echo $localidad['id'] ?>">
