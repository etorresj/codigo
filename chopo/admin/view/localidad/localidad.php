...
<div id="wrapper">
	...
	<div id="rightContent">
		...
		<h3>Localidades</h3>
		<table class="data">
			<form method="post" action="index.php?section=localidad">
				<tr>
					<td colspan="5">
						<table width="100%">
							<tr>
								<td>
									<a href="?section=agregarLocalidad">
										<input type="button" class="button" value="Agregar Localidad">
									</a>
								</td>
								<td align="right">
			...
			<tr class="data">
				...
				<th class="data" width="75px">CP</th>
			...
			<tr class="data">
				...
				<td class="data"><?php echo $localidad['nombreRegion'] ?></td>
				<td class="data" width="75px"><?php echo $localidad['cp'] ?></td>
				<td class="data" width="75px">
				<center>
					<a href="?section=editarLocalidad&id=<?php echo $localidad['id'] ?>">
