	...
	<div id="rightContent">
		...
		<table class="data">
				...
				<tr>
					<td colspan="3">
						<table width="100%">
							<tr>
								<td>
									<a href="?section=agregarFolio">
										<input type="button" class="button" value="Agregar Folio">
									</a>
								</td>
								<td align="right">
			...
			<tr class="data">
				...
				<td class="data"><?php echo $folio['folio'] ?></td>
				<td class="data" width="75px">
				<center>
					<a href="?section=editarFolio&id=<?php echo $folio['id'] ?>">
