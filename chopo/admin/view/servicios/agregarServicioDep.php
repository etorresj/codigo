...
<div id="wrapper">
	...
	<div id="rightContent">
		...
		<?php
			if($success) echo '<div class="sukses">Servicio agregado correctamente</div>';
			else if($error) echo '<div class="gagal">Error agregando datos</div>'; 
		?>
		<h3>Agregar Estudio</h3>
		<form method="post" action="?section=agregarServicioDep" enctype="multipart/form-data">
			<table class="data">
				<tr>
				...
				<tr>
					...
					<td>
						<textarea name="indicacion"></textarea>
					</td>
				</tr>
				<tr>
