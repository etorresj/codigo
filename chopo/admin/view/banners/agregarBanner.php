...
<div id="wrapper">
	...
	<div id="rightContent">
		...
		<?php
			if($success) echo '<div class="sukses">Banner agregado correctamente</div>';
			else if($error) echo '<div class="gagal">Tipo de archivo no válido</div>'; 
		?>
		<h3>Agregar Banner</h3>
		<form method="post" action="?section=agregarBanner" enctype="multipart/form-data" name="forma1" id="forma1">
			<table class="data">
				...
				<tr>
					...
					<td class="data">
						<input type="text" name="url" value="http://" class="panjang">
					</td>
				</tr>
