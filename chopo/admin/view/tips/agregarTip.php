...
<div id="wrapper">
	...
	<div id="rightContent">
		...
		<form method="post" action="?section=agregarTip" enctype="multipart/form-data" name="forma1" id="forma1">
			<table class="data">
				<tr>
				...
				<tr>
					...
					<td class="data">
						...
						<input type="text" readonly="readonly" name="fecha" id="fecha" class="sedang">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="data">
						<textarea name="texto" id="texto" style="width:600px;"></textarea>
					</td>
				</tr>
