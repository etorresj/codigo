...
<div id="slider1wrap"> 
            ...
            <div id="slider" class="sl-slider-wrapper">
				...
				<?php $sliders=$chopo->getBannersFront($_SESSION['chopoRegion']);
				$i=1;
	...
	<div id="content">  
		...
		<div class="boxverde der" onclick="window.location='sucursales.php'">
			<img src="images/serv-sucursales.png" alt="serv-sucursales" width="52" height="51" />
				...
				<p>Más de 170 sucursales, servicio los 365 días del año</p><a href="sucursales.php" class="link">Ver más</a>
		</div>
		...
		<div class="slider2">
			...
			<?php
			$promociones = $chopo->getPromocionesHome($_SESSION['chopoRegion']);
			...
			<div class="article">
				<a href="promocion.php?codigoPromo=<?php echo $promocion['codigo']; ?>&region=<?php echo $_SESSION['chopoRegion']; ?>" class="azul"><img src="images/promocion/<?php echo $promocion['imagen'] ?>" alt="<?php echo $promocion['nombre'] ?>" width="100" height="100"></a>
				<span class="azul"><?php echo utf8_encode($promocion['nombre']) ?></span>
				<p><?php 
				if($promocion['precio']) {
					if(is_numeric($promocion['precio'])) {
						echo "Desde $".$promocion['precio'].".00 pesos";
						echo "<br>";
					}
					else {
					...
					echo "<br>";
				 ?></p>
				<a href="promocion.php?codigoPromo=<?php echo $promocion['codigo']; ?>&region=<?php echo $_SESSION['chopoRegion']; ?>" class="azul">Ver más</a>
			</div>
			...
			<div class="slider2">
				<div class="carousel-wrap">
					<div class="phenix one">
						<?php $tips=$chopo->getTipsFront("","",$_SESSION['chopoRegion']); 
							if($tips)
							foreach($tips as $tip) {
						?>
						<div class="article-one">
							...
							<a href="tips.php?id=<?php echo $tip['id']; ?>"><img src="images/seguir-leyendo.jpg" alt="seguir-leyendo" class="imgtip" /></a>
							<div style="clear:both"></div>
						</div>
						<?php } ?>
					</div>
