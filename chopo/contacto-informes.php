...
<?php include('navegador-contacto.php') ?> 
	...
	<div id="content-in">
		<div id="left-menu">
			<ul>
				<a href="contacto-informes.php"><li class="select">Informes</li></a>
		...
		<div id="right-content">
			<div class="privilegios">
				...
				<input type="hidden" value="informes" name="pagina">
				<h1>INFORMES</h1>
					...
					<?php } ?>
					<p>¿Dudas o preguntas sobre nuestros servicios? Exponlas aquí y trataremos de resolverlas lo antes posible.</p>
					<p>*Nombre
					...
					<p>Sucursal
						<input type="text" name="sucursal"></p>
