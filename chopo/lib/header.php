...
<html>
	<head>
        ...
        <script language="javascript" type="text/javascript" src="http://chopo.com.mx/customer-service/client.php?key=L7F8526A6V1248A52BM4F0C3C2"></script>
        ...
        <header>
			<div id="contactwrap">   
				<div id="contact"> 
					...
					<div id="contacto"> 
						<a href="contacto-informes.php"><img src="images/contacto.png" alt="contacto" width="120" height="30"></a>
					</div>	
			...
			<div id="submenuwrap">   
				<div id="submenu"> 
					<div id="search"> 
						<form action="buscador.php" name="buscador" method="post">
						<input type="text" name="search" class="headersearch" >
						<input type="image" src="images/search-lupa.jpg" alt="search-lupa" class="headersearch lupa" value=""  onclick="if(search.value == ''){
							alert('Escriba una palabra de busqueda'); 
							search.focus();
							return false;
		                    }">
						</form>
