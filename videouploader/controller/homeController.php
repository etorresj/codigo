...
if($_POST){
	...
	if($_SESSION['ooyalaUser']['property']!=0){
	$token2=$uploader->getTokens($_SESSION['ooyalaUser']['property']);
	$api2 = new OoyalaApi($token2[0]['apikey'], $token2[0]['apisecret']);
	$labels=$api2->get("labels");
	}
	/*
	echo '<pre>';
	print_r($labels);
