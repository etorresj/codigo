	...
	<div id="rightContent">
				...
				<tr>
					<td colspan="10">
						<table width="100%">
							<tr>
								<td>
									<a href="?section=agregarSeccion&idRevista=<?php echo $id; ?>&ms=<?php echo $muestraSubtemas;?>">
										<input type="button" class="button" value="Agregar <?php echo $tituloB; ?>">
									</a>
								</td>
        ...
        <?php if(!$muestraSubtemas) { ?>
				         <th class="data" width="75px">Orden</th>
								 <th class="data" width="75px">Imagenes</th>
								 <!--<th class="data" width="75px">Temas</th>-->
				<?php } ?>
				...
				<th class="data" width="75px">Stats</th>
				<?php } ?>
			...
			<tr class="data">
            	...
            	<?php if(!$muestraSubtemas) { ?>
                 <td class="data"><center>
							  <?php  if($j>0) { ?>
			      <a href="ordenS2.php?id=<?php echo $localidad['id']; ?>&amp;order=1&amp;tipo=<?php echo $tipo; ?>"><img src="css/img/arriba.png" width="16" height="16" border="0" /></a>
			      <?php } else  { ?>
			      <img src="css/img/vacio.gif" width="16" height="16" border="0" />
			      <?php } if ($j<$registros) { ?>
			      <a href="ordenS2.php?id=<?php echo $localidad['id']; ?>&amp;order=0&amp;tipo=<?php echo $tipo; ?>"><img src="css/img/abajo.png" width="16" height="16" border="0" /></a>
			      <?php } else { ?>
			      <img src="css/img/vacio.gif" width="16" height="16" border="0" />
			      <?php
				...
				<center>
					<a href="?section=fondos&tipo=<?php echo $localidad['id'] ?>&padre=<?php echo $id;?>">
						<img src="css/img/insert_image_2.png" width="16">
					</a>
				</center>
				</td>
<!--
				<td class="data" width="75px">
				<center>
					<a href="?section=editarRevista2&id=<?php echo $localidad['id'] ?>&padre=<?php echo $id;?>">
						<img src="css/img/write.png" width="16">
					</a>
				</center>
				</td>
		-->
				...
				<td class="data" width="75px">
				<center>
					<a href="?section=editarSeccion&id=<?php echo $localidad['id'] ?>&ms=<?php echo $muestraSubtemas;?>">
				...
				<td class="data" width="75px">
				<center>
					<a href="?section=estadisticas&id=<?php echo $localidad['id'] ?>" target="_blank">
						<img src="css/img/stats.png" width="16">
					</a>
				</center>
				</td>
				...
				<td class="data" width="75px">
				<center>
					<img  src="css/img/deletered.png" style="cursor:pointer;" width="16" onClick="eliminarSeccion('<?php echo $localidad['id']; ?>', '<?php echo $id; ?>');">
				</center>
				</td>
		  </tr>
			<?php
