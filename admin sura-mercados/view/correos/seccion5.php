                                    ...
                                    <td>
                                       ...
                                       <table width="200" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner">
                                          <tbody>
                                             <!-- title -->
                                             <tr>
                                                <td bgcolor="#00aecb" style="font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif; font-size: 30px; color:#FFF; text-align:left;line-height:37px; padding:0 14px 0 14px; background:#00aecb" width="200" height="175" align="center" class="recuadro">
                                                 Seguros de Vida
                                                </td>
                                             </tr>
                                              <!-- end of title -->
